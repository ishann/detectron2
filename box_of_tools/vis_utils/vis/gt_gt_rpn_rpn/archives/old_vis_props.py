"""
    Changelog:
    [1] Builds on top of epi2.
    [2] Works only for bbox outputs of lvis_test.py.
"""
################################################################################
##  Import.                                                                   ##
################################################################################
...
#OUT_PATH = '/scratch/cluster/ishann/data/lvis/vis/gt/val2017_pr'
#VID_NAME = '/scratch/cluster/ishann/data/lvis/vis/gt/val2017_pr/lvis_val.mp4'
ANN_PATH = '/scratch/cluster/ishann/data/lvis/annotations/lvis_val_100.json'
PRE_PATH = '/scratch/cluster/ishann/research/recognizing-every-thing/logs/ret/' + \
           'ret0001/results_gtbbox_sam100/ret0001_gtbbox_30_json_results.bbox.json'
OUT_PATH = '/scratch/cluster/ishann/data/lvis/vis/sample'
VID_NAME = '/scratch/cluster/ishann/data/lvis/vis/sample/lvis_sam.mp4'
...
def main():
    ...
    for i, img_id in enumerate(img_ids):
        ...
        img_name = 'pre_{}.jpg'.format(str(img_id).zfill(12))
        cv2.imwrite(os.path.join(OUT_PATH, img_name), pred_img)
        img_seq.append(pred_img)
