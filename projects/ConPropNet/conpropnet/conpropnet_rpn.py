...
class ConPropNetRPN(RPN):
    """
    Region Proposal Network, introduced by the Faster R-CNN paper.
    """

    def __init__(self, cfg, input_shape):
        super(ConPropNetRPN, self).__init__(cfg, input_shape)

        # If we create a new anchor generator, we might have to do our own:
        # self.anchor_generator = build_anchor_generator(cfg, [input_shape[f] for f in self.in_features])

        # All of this was taken care of in super(ConPropNetRPN, self).__init__(cfg, input_shape)
        # fmt: off
