...
__all__ = ["default_argument_parser", "default_setup", "EmbeddingPredictor", "EmbeddingTrainer"]
...
class EmbeddingTrainer(SimpleTrainer):
    """
    This trainer is derived from DefaultTrainer (in defaults.py).
