"""
Modified from plain_train_net.py.

Assumptions:
    [1] No testing. This only trains networks.
    [2] Custom data is always assumed to be in COCO format. Custom data is
        registered with register_coco_instances().
    [3] DO NOT assume that LVIS meta-data is available.
"""
...
def main(args):
    ...
    if cfg.DATASETS.TRAIN == "COCO_n_LVIS_train":
        ...
        raise NotImplementedError(
                "Unknown custom dataset: {}".format(cfg.DATASETS.TRAIN)
            )
    ...
    return OrderedDict() # This is what do_test() would have returned in absence of any testing.
